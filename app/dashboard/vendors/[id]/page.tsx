          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              {Array.from({ length: 5 }).map((_, i) => (
                <Star key={i} className={`w-4 h-4 ${i < vendor.rating ? "fill-[#eca8d6] text-[#eca8d6]" : "text-muted-foreground/30"}`} />
              ))}
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 space-y-4">
                {vendor.reviews.map((review: any) => (
                  <article key={review.id} className="bg-background border border-foreground/5 p-4 rounded-md">
                      ...
                      <div>
                        ...
                        <div className="mt-2 text-sm text-muted-foreground">
                          {expandedReview === review.id ? (
                            ...
                            <p>{review.text.length > 140 ? review.text.slice(0, 140) + "..." : review.text}</p>
                          )}
                        </div>
                      </div>
