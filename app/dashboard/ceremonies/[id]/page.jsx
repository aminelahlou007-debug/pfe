...
export default function EditCeremonyPage() {
    ...
    const handleDelete = async () => {
        if (!confirm("Are you sure you want to delete this ceremony?"))
            return;
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-card border border-foreground/10 p-6 space-y-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              ...
              <input type="text" name="name" value={formData.name} onChange={handleChange} required className="w-full h-10 px-4 bg-background border border-foreground/10 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-foreground/20"/>
            </div>
            ...
            <div>
              ...
              <input type="number" name="expectedGuests" value={formData.expectedGuests} onChange={handleChange} className="w-full h-10 px-4 bg-background border border-foreground/10 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-foreground/20"/>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card border border-foreground/10 p-6 space-y-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2">
              ...
              <input type="text" name="venue" value={formData.venue} onChange={handleChange} className="w-full h-10 px-4 bg-background border border-foreground/10 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-foreground/20"/>
            </div>
            
            <div className="sm:col-span-2">
              <label className="block text-sm font-medium mb-2">Address</label>
              <input type="text" name="address" value={formData.address} onChange={handleChange} className="w-full h-10 px-4 bg-background border border-foreground/10 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-foreground/20"/>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card border border-foreground/10 p-6 space-y-6">
          ...
          <div>
            ...
            <input type="text" name="budget" value={formData.budget} onChange={handleChange} className="w-full h-10 px-4 bg-background border border-foreground/10 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-foreground/20"/>
          </div>
          
          <div>
            <label className="block text-sm font-medium mb-2">Description</label>
            <textarea name="description" value={formData.description} onChange={handleChange} rows={4} className="w-full px-4 py-3 bg-background border border-foreground/10 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-foreground/20 resize-none"/>
          </div>
        </div>
