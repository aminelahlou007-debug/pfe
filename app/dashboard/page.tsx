      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat) => (
          <Link
            key={stat.label}
            href={stat.href}
            className="group p-6 bg-card border border-foreground/10 hover:border-foreground/20 transition-all"
          >
        ...
        <div className="bg-card border border-foreground/10 p-6">
          ...
          <div className="space-y-4">
            {recentActivity.map((activity, index) => (
              <div key={index} className="pb-4 border-b border-foreground/5 last:border-0 last:pb-0">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <Link
            key={action.label}
            href={action.href}
            className="flex items-center gap-3 p-4 bg-card border border-foreground/10 hover:border-foreground/20 transition-all group"
          >
