...
const logos = {
    OpenAI: (<svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    Anthropic: (<svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    Slack: (<svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    GitHub: (<svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    Jira: (<svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    "AWS S3": (<svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    "Google Drive": (<svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    Salesforce: (<svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    HubSpot: (<svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    Zapier: (<svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    Snowflake: (<svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    Stripe: (<svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
...
export function IntegrationsSection() {
    ...
    return (<section id="integrations" ref={sectionRef} className="relative overflow-hidden">
      ...
      <div className={`relative left-1/2 -translate-x-1/2 w-screen -mt-16 transition-all duration-1000 delay-200 ${isVisible ? "opacity-100" : "opacity-0"}`}>
        <video aria-hidden="true" muted autoPlay loop playsInline preload="metadata" poster="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/connection-KeJwWPQvn6l0a7C48tCARYtNEdC92H.png" className="w-full h-auto object-cover">
      ...
      <div className="relative z-10 mt-0 lg:-mt-24 max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-16">
          {integrations.map((integration, index) => (<div key={integration.name} className={`group relative overflow-hidden p-6 lg:p-8 border transition-all duration-500 cursor-default ${hoveredIndex === index
                ? "border-foreground bg-foreground/[0.04] scale-[1.02]"
                : "border-foreground/10 hover:border-foreground/30"} ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{
              ...
              {hoveredIndex === index && mousePos && (<span aria-hidden="true" className="pointer-events-none absolute inset-0 z-0" style={{
        ...
        ].map((stat) => (<div key={stat.label} className="flex items-baseline gap-3">
