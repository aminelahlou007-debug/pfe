...
const steps = [
    {
        ...
        title: "Create",
        subtitle: "your event",
        description: "Start by setting up your event details, date, and vision. Our intuitive wizard guides you through every step.",
    },
    {
        number: "02",
        title: "Build",
        subtitle: "your team",
        description: "Add vendors, coordinators, and assign roles. Everyone gets access to what they need, nothing more.",
    },
    {
        number: "03",
        title: "Manage",
        subtitle: "& execute",
        description: "Track RSVPs, coordinate vendors, and on the day, our timeline keeps everyone synchronized perfectly.",
    },
];
export function HowItWorksSection() {
    ...
    return (<section id="how-it-works" ref={sectionRef} className="relative py-24 lg:py-32 bg-[oklch(0.09_0.01_260)] text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-16 opacity-0"}`}>
              ...
              <span className="block text-white/10">Celebrate.</span>
            </h2>
          </div>
          ...
          <div className={`relative h-[320px] lg:h-[640px] overflow-hidden transition-all duration-1000 delay-200 ${isVisible ? "opacity-100" : "opacity-0"}`}>
            <video aria-hidden="true" muted autoPlay loop playsInline preload="metadata" poster="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/tree-uAia6REvB137CQyHFCf0za3O6h2zKO.png" className="absolute bottom-0 left-0 w-full h-full object-contain object-bottom">
        ...
        <div className="grid lg:grid-cols-3 gap-4">
          {steps.map((step, index) => (<button key={step.number} type="button" onClick={() => setActiveStep(index)} className={`relative text-left p-8 lg:p-12 border transition-all duration-500 ${activeStep === index
