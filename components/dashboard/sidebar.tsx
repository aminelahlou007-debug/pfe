...
export function DashboardSidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 border-r border-foreground/10 bg-card">
      {/* Logo */}
      ...
      <div className="py-6 px-3 border-t border-foreground/10">
        <div className="space-y-1">
          ...
          <Link
            href="/"
            className="flex items-center gap-3 px-3 py-2.5 text-sm rounded-lg text-muted-foreground hover:text-foreground hover:bg-foreground/5 transition-colors"
          >
